...
describe "AlbumList" do
  describe "#getAlbumList" do
    before(:all) do
      ...
      FactoryBot.create(:album, id: 1, title: "Midnight Memories", artist: artist_one, user_rating: "4.4", average_rating: "1.6", year: 1991, play_count: 0, starred: false,
                                last_played_at: 11.days.ago)
      FactoryBot.create(:album, id: 2, title: "Breakfast in America", artist: artist_two, user_rating: "4.4", average_rating: "1.6", year: 1992, play_count: 2, starred: false,
                                last_played_at: 3.days.ago)
      FactoryBot.create(:album, id: 3, title: "Metallica", artist: artist_three, user_rating: "4.8", average_rating: "2.8", year: 1995, play_count: 1, starred: true,
                                last_played_at: 5.days.ago)
      FactoryBot.create(:album, id: 4, title: "Frozen", artist: artist_one, user_rating: "3.9", average_rating: "1.3", year: 1996, play_count: 5, starred: false,
                                last_played_at: 7.days.ago)
      FactoryBot.create(:album, id: 5, title: "Born in the U.S.A.", artist: artist_two, user_rating: "2.5", average_rating: "1.7", year: 1999, play_count: 9, starred: false,
                                last_played_at: 9.days.ago)
      FactoryBot.create(:album, id: 6, title: "Legend: The Best of Bob Marley &amp; The Wailers", artist: artist_three, user_rating: "1.6",
                                average_rating: "1.2", year: 2000, play_count: 0, starred: true, last_played_at: 1.days.ago)
      FactoryBot.create(:album, id: 7, title: "Happy Nation", artist: artist_one, user_rating: "4.0", average_rating: "2.9", year: 2005, play_count: 10, starred: false,
                                last_played_at: 2.days.ago)
      FactoryBot.create(:album, id: 8, title: "Rumours", artist: artist_one, user_rating: "4.5", average_rating: "2.3", year: 2020, play_count: 6, starred: false,
                                last_played_at: 12.days.ago)
    end
...
<subsonic-response xmlns="http://subsonic.org/restapi" version="1.16.1" status="ok">
  <error code="10" message="when type is by_year, both from_year and to_year are required" />
      ...
      describe("alphabeticalByName") do
      ...
      describe("offset and size") do
        before(:all) do
          FactoryBot.create(:album, title: "Midnight Memories", user_rating: "4.4", average_rating: "1.6", year: 1991, play_count: 0, starred: false,
                                    last_played_at: 11.days.ago)

          FactoryBot.create_list(:album, 30)
        end
        describe("offset") do
          let(:type) { "alphabeticalByArtist" }
